							...
							<div class="product-img">
								...
								<div class="button-head">
									<div class="product-action">
										<a data-toggle="modal" data-target="#exampleModal" title="Lihat Detail" href="#"><i class="ti-eye"></i><span>Lihat Detail</span></a>
										<a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Tambah Wishlist</span></a>
									</div>
									<div class="product-action-2">
										<a title="Add to cart" href="#"><i class="ti-shopping-cart"></i> Tambah ke Keranjang</a>
									</div>
								</div>
							</div>
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#mangkok" role="tab">Mangkok</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#piring" role="tab">Piring</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#bedrunner" role="tab">Bed Runner</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tempatsampah" role="tab">Tempat Sampah</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#kotaktisu" role="tab">Kotak Tisu</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#bantalsegitiga" role="tab">Bantal Segitiga</a></li>
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent">
								<!-- Start Single Tab -->
								<div class="tab-pane fade show active" id="mangkok" role="tabpanel">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade" id="piring" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade" id="bedrunner" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade" id="tempatsampah" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade" id="kotaktisu" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade" id="bantalsegitiga" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
